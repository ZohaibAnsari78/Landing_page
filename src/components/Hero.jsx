...
const Hero = () => {
  return (
    <div id='Hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        viewport={{once: true}}
        className='text-sm sm:text-lg font-medium to-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turing big ideas into intractive digital experiences.</motion.p>
