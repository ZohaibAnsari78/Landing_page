...
const ServiceCard = ({service, index}) => {
  ...
  return (
    <div 
      ...
      className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-2xl shadow-gray-200 dark:shadow-white/10'
    >
